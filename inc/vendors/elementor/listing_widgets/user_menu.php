...
class Findus_Elementor_User_Menu extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus User Profile Menu', 'findus' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Navigation Menu', 'findus' ),
        ...
        $this->start_controls_section(
            'section_menu_style',
            [
                'label' => esc_html__( 'Menu Item', 'findus' ),
                'tab' => Elementor\Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'menu_color',
            [
                'label' => esc_html__( 'Menu Color', 'findus' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'menu_color_hover',
            [
                'label' => esc_html__( 'Menu Color Hover', 'findus' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_group_control(
            Elementor\Group_Control_Typography::get_type(),
            [
                'label' => esc_html__( 'Menu Typography', 'findus' ),
	...
	protected function render() {
        ...
        ?>
        <div class="widget-nav-menu widget <?php echo esc_attr($el_class); ?>">
                ...
                <div class="top-info">
                    ...
                    <div class="wrapper-title">
                        ...
                        <div class="date-created">
                            <?php 
                                printf(esc_html__('Member Since : %s', 'findus'), date_i18n( "M Y", strtotime( $registered ) )  );
                            ?>
                        </div>
                    </div>
                </div>
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Findus_Elementor_User_Menu );
} else {
    Elementor\Plugin::instance()->widgets_manager->register( new Findus_Elementor_User_Menu );
}