...
class Findus_Elementor_Logo extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Apus Header Logo', 'findus' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'image',
            [
                'label' => esc_html__( 'Main Logo', 'findus' ),
        ...
        $this->add_control(
            'image_transparent',
            [
                'label' => esc_html__( 'Transparent Header Logo', 'findus' ),
                'type' => Controls_Manager::MEDIA,
                'dynamic' => [
                    'active' => true,
                ],
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Findus_Elementor_Logo );
} else {
    Plugin::instance()->widgets_manager->register( new Findus_Elementor_Logo );
}