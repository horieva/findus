...
class Findus_Elementor_Nav_Menu extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Navigation Menu', 'findus' );
    }
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Findus_Elementor_Nav_Menu );
} else {
    Elementor\Plugin::instance()->widgets_manager->register( new Findus_Elementor_Nav_Menu );
}