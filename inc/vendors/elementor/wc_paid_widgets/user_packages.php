...
class Findus_Elementor_Listings_User_Packages extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus User Packages', 'findus' );
    }
	...
	protected function render() {
        ...
        <div class="widget-user-packages <?php echo esc_attr($el_class); ?>">
            ...
            if ( ! is_user_logged_in() ) {
                ...
                ?>
                        ...
                        <div class="widget-content">
                            <table>
                                <thead>
                                    <tr>
                                        <td><?php esc_html_e('ID', 'findus'); ?></td>
                                        <td><?php esc_html_e('Package', 'findus'); ?></td>
                                        <td><?php esc_html_e('Posted', 'findus'); ?></td>
                                        <td><?php esc_html_e('Limit Posts', 'findus'); ?></td>
                                        <td><?php esc_html_e('Listing Duration', 'findus'); ?></td>
                                        <td><?php esc_html_e('Status', 'findus'); ?></td>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if ( $_package_count >= $_listings_limit && $_listings_limit != 0 ) {
                                                    echo '<span class="action finish">'.esc_html__('Finished', 'findus').'</span>';
                                                } else {
                                                    echo '<span class="action active">'.esc_html__('Active', 'findus').'</span>';
                                                }
                                                ?>
                                            </td>
                                        </tr>
                ...
                <?php } else { ?>
                    <div class="text-warning"><?php esc_html_e( 'No packages found.', 'findus' ); ?></div>
                <?php } ?>
            </div>
            <?php
        }
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Findus_Elementor_Listings_User_Packages );
} else {
    Plugin::instance()->widgets_manager->register( new Findus_Elementor_Listings_User_Packages );
}