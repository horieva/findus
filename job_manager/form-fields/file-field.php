	...
	<div class="form-group group-upload">
        <div class="upload-file-btn">
            ...
            <?php if ( ! empty( $field['multiple'] ) ) {
            	?>
            	<span><?php esc_html_e('Add Images', 'findus'); ?></span>
            	<?php
            } else {
            	?>
            	<span><?php esc_html_e('Add Image', 'findus'); ?></span>
            	<?php
            } ?>
...
<small class="description">
	...
	<?php else : ?>
		<?php printf( esc_html__( 'Maximum file size: %s.', 'findus' ), size_format( wp_max_upload_size() ) ); ?>
	<?php endif; ?>
</small>