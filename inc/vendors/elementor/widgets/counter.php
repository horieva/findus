 ...
 * @since 1.0.0
 */
class Findus_Elementor_Counter extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Apus Counter', 'findus' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_counter',
			[
				'label' => esc_html__( 'Counter', 'findus' ),
			]
		);
		...
		$this->add_control(
			'starting_number',
			[
				'label' => esc_html__( 'Starting Number', 'findus' ),
		...
		$this->add_control(
			'ending_number',
			[
				'label' => esc_html__( 'Ending Number', 'findus' ),
				'type' => Controls_Manager::NUMBER,
				'default' => 100,
				'dynamic' => [
					'active' => true,
		...
		$this->add_control(
			'prefix',
			[
				'label' => esc_html__( 'Number Prefix', 'findus' ),
		...
		$this->add_control(
			'suffix',
			[
				'label' => esc_html__( 'Number Suffix', 'findus' ),
				'type' => Controls_Manager::TEXT,
				'dynamic' => [
					'active' => true,
				],
				'default' => '',
				'placeholder' => esc_html__( 'Plus', 'findus' ),
			]
		);
		...
		$this->add_control(
			'duration',
			[
				'label' => esc_html__( 'Animation Duration', 'findus' ),
				'type' => Controls_Manager::NUMBER,
				'default' => 2000,
				'min' => 100,
				'step' => 100,
		...
		$this->add_control(
			'thousand_separator',
			[
				'label' => esc_html__( 'Thousand Separator', 'findus' ),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'yes',
				'label_on' => esc_html__( 'Show', 'findus' ),
				'label_off' => esc_html__( 'Hide', 'findus' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Separator', 'findus' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => esc_html__( 'Cool Number', 'findus' ),
				'placeholder' => esc_html__( 'Cool Number', 'findus' ),
			]
		);
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Findus_Elementor_Counter );
} else {
    Plugin::instance()->widgets_manager->register( new Findus_Elementor_Counter );
}