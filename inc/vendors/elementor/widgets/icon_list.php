 ...
 * @since 1.0.0
 */
class Findus_Elementor_Icon_List extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Apus Icon List', 'findus' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_icon',
			[
				'label' => esc_html__( 'Icon List', 'findus' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'inline' => [
						'title' => esc_html__( 'Inline', 'findus' ),
		...
		$repeater->add_control(
			'text',
			[
				'label' => esc_html__( 'Text', 'findus' ),
				'type' => Controls_Manager::TEXT,
				'label_block' => true,
				'placeholder' => esc_html__( 'List Item', 'findus' ),
				'default' => esc_html__( 'List Item', 'findus' ),
				'dynamic' => [
					'active' => true,
				],
			]
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'text' => esc_html__( 'List Item #1', 'findus' ),
						'selected_icon' => [
							'value' => 'fas fa-check',
							'library' => 'fa-solid',
						],
					...
					[
						'text' => esc_html__( 'List Item #2', 'findus' ),
						'selected_icon' => [
							'value' => 'fas fa-times',
							'library' => 'fa-solid',
						],
					...
					[
						'text' => esc_html__( 'List Item #3', 'findus' ),
						'selected_icon' => [
		...
		$this->add_responsive_control(
			'space_between',
			[
				'label' => esc_html__( 'Space Between', 'findus' ),
		...
		$this->add_control(
			'divider',
			[
				'label' => esc_html__( 'Divider', 'findus' ),
				'type' => Controls_Manager::SWITCHER,
				'label_off' => esc_html__( 'Off', 'findus' ),
				'label_on' => esc_html__( 'On', 'findus' ),
				'selectors' => [
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'solid' => esc_html__( 'Solid', 'findus' ),
					'double' => esc_html__( 'Double', 'findus' ),
					'dotted' => esc_html__( 'Dotted', 'findus' ),
					'dashed' => esc_html__( 'Dashed', 'findus' ),
				],
				'default' => 'solid',
				'condition' => [
					'divider' => 'yes',
		...
		$this->add_control(
			'divider_weight',
			[
				'label' => esc_html__( 'Weight', 'findus' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 1,
				],
		...
		$this->add_control(
			'text_indent',
			[
				'label' => esc_html__( 'Text Indent', 'findus' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Findus_Elementor_Icon_List );
} else {
    Plugin::instance()->widgets_manager->register( new Findus_Elementor_Icon_List );
}