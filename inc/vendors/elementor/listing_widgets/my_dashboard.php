...
class Findus_Elementor_Listings_My_Dashboard extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus My Dashboard', 'findus' );
    }
	...
	protected function render() {
        ...
        <div class="widget widget-my-dashboard <?php echo esc_attr($el_class); ?>">
            ...
            if ( ! is_user_logged_in() ) {
                ...
                $url = findus_get_user_url($current_user_id, $data->user_nicename);
            ?>
                <h3 class="user-name">
                    <span class="prifix-user"><?php echo esc_html__('Hello ','findus') ?></span>
                    <?php if ( !empty($url) ) { ?>
                            ...
                            <div class="item active-listing">
                                <div class="flex-middle">
                                    <div class="left-inner">
                                        ...
                                        <div class="listings-text"><?php esc_html_e('All Listings', 'findus'); ?></div>
                                    </div>
                            ...
                            <div class="item view-listing">
                                <div class="flex-middle">
                                    <div class="left-inner">
                                        ...
                                        <div class="listings-text"><?php esc_html_e('Total Views', 'findus'); ?></div>
                                    </div>
                                    <div class="right-inner ali-right">
                            ...
                            <div class="item review-listing">
                                <div class="flex-middle">
                                    <div class="left-inner">
                                        ...
                                        <div class="listings-text"><?php esc_html_e('Total Reviews', 'findus'); ?></div>
                                    </div>
                                    <div class="right-inner ali-right">
                            ...
                            <div class="item bookmard-listing">
                                <div class="flex-middle">
                                    <div class="left-inner">
                                        ...
                                        <div class="listings-text"><?php esc_html_e('Total Bookmarks', 'findus'); ?></div>
                                    </div>
                                    <div class="right-inner ali-right">
                        ...
                        <div class="col-lg-3 col-xs-6 col-sm-6">
                            <div class="item flex-middle published">
                                <div class="left-inner">
                                    ...
                                    <div class="listings-text"><?php esc_html_e('Published', 'findus'); ?></div>
                                </div>
                                <div class="right-inner ali-right">
                        ...
                        <div class="col-lg-3 col-xs-6 col-sm-6">
                            <div class="item flex-middle pending">
                                <div class="left-inner">
                                    ...
                                    <div class="listings-text"><?php esc_html_e('Pending', 'findus'); ?></div>
                                </div>
                                <div class="right-inner ali-right">
                                    <i class="ti-reload"></i>
                                </div>
                        ...
                        <div class="col-lg-3 col-xs-6 col-sm-6">
                            <div class="item flex-middle unpaid">
                                <div class="left-inner">
                                    ...
                                    <div class="listings-text"><?php esc_html_e('UnPaid', 'findus'); ?></div>
                                </div>
                                <div class="right-inner ali-right">
                                    <i class="ti-money"></i>
                                </div>
                        ...
                        <div class="col-lg-3 col-xs-6 col-sm-6">
                            <div class="item flex-middle expired">
                                <div class="left-inner">
                                    ...
                                    <div class="listings-text"><?php esc_html_e('Expired', 'findus'); ?></div>
                                </div>
                                <div class="right-inner ali-right">
                                    <i class="ti-lock"></i>
                                </div>
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Findus_Elementor_Listings_My_Dashboard );
} else {
    Elementor\Plugin::instance()->widgets_manager->register( new Findus_Elementor_Listings_My_Dashboard );
}