...
$sidebar = findus_get_listings_sidebar_configs();
...
?>
	<div class="wrapper-filters1 filter-v1 clearfix">
			...
			if( in_array($layout, $layouts)) { ?>
				...
				<button class=" btn btn-sm btn-theme btn-view-map" type="button"><i class="far fa-map"></i> <?php esc_html_e( 'Map View', 'findus' ); ?></button>
				<button class=" btn btn-sm btn-theme  btn-view-listing hidden-sm hidden-xs" type="button"><i class="fas fa-list"></i> <?php esc_html_e( 'Listing View', 'findus' ); ?></button>
				</div>
			<?php } ?>
