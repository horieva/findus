<div class="price_slider_wrapper">
	<?php
		$min_default = findus_get_config('listing_filter_price_min_default', 0);
		$max_default = findus_get_config('listing_filter_price_max_default', 1000000);
	...
	?>
	<div class="price-wrapper"><?php echo esc_html__('Price: ', 'findus'); ?> 
		<span class="price">
			<span class="price_from"><?php findus_listing_display_price($min); ?></span>
			<span class="space">-</span>
			<span class="price_to"><?php findus_listing_display_price($max); ?></span>
		</span>
	</div>
