...
if ( !$display_warning ) {
	...
	Findus_Submittion::job_manager_dropdown_categories( apply_filters( 'job_manager_term_multiselect_field_args', $args ) );
} else {
	?>
	<div class="alert alert-warning"><?php esc_html_e('Please choose category to display available features', 'findus'); ?></div>
	<?php
}
