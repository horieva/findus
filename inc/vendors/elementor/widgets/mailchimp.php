...
class Findus_Elementor_Mailchimp extends Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus MailChimp Sign-Up Form', 'findus' );
    }
	...
	protected function register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'MailChimp Sign-Up Form', 'findus' ),
        ...
        $this->add_control(
            'input_bg_color',
            [
                'label' => esc_html__( 'Input Background', 'findus' ),
                'type' => Controls_Manager::COLOR,
        ...
        $this->add_control(
            'input_color',
            [
                'label' => esc_html__( 'Input Color', 'findus' ),
                'type' => Controls_Manager::COLOR,
        ...
        $this->add_control(
            'input_placeholder',
            [
                'label' => esc_html__( 'Input Placeholder ', 'findus' ),
                'type' => Controls_Manager::COLOR,
        ...
        $this->add_control(
            'input_border_color',
            [
                'label' => esc_html__( 'Input Border Color', 'findus' ),
                'type' => Controls_Manager::COLOR,
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Plugin::instance()->widgets_manager->register_widget_type( new Findus_Elementor_Mailchimp );
} else {
    Plugin::instance()->widgets_manager->register( new Findus_Elementor_Mailchimp );
}