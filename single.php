...
?>
<section id="main-container" class="main-content content-space <?php echo apply_filters('findus_blog_content_class', 'container');?>">
				...
				<div id="content" class="site-content detail-post" role="main">
					<?php
						...
						while ( have_posts() ) : the_post();
							...
							if ( findus_get_config('show_blog_releated', false) ): ?>
