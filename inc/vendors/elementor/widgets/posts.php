...
class Findus_Elementor_Posts extends Elementor\Widget_Base {
	...
	public function get_title() {
        return esc_html__( 'Apus Posts', 'findus' );
    }
	...
	protected function register_controls() {
        ...
        $this->add_control(
            'number',
            [
                'label' => esc_html__( 'Number', 'findus' ),
                'type' => Elementor\Controls_Manager::NUMBER,
                'input_type' => 'number',
                'description' => esc_html__( 'Number posts to display', 'findus' ),
                'default' => 4
            ]
        );
        ...
        $this->add_control(
            'order_by',
            [
                'label' => esc_html__( 'Order by', 'findus' ),
                'type' => Elementor\Controls_Manager::SELECT,
                'options' => array(
                    '' => esc_html__('Default', 'findus'),
                    'date' => esc_html__('Date', 'findus'),
                    'ID' => esc_html__('ID', 'findus'),
                    'author' => esc_html__('Author', 'findus'),
                    'title' => esc_html__('Title', 'findus'),
                    'modified' => esc_html__('Modified', 'findus'),
                    'rand' => esc_html__('Random', 'findus'),
                    'comment_count' => esc_html__('Comment count', 'findus'),
                    'menu_order' => esc_html__('Menu order', 'findus'),
                ),
                'default' => ''
            ]
        );
        ...
        $this->add_control(
            'order',
            [
                'label' => esc_html__( 'Sort order', 'findus' ),
                'type' => Elementor\Controls_Manager::SELECT,
                'options' => array(
                    '' => esc_html__('Default', 'findus'),
                    'ASC' => esc_html__('Ascending', 'findus'),
                    'DESC' => esc_html__('Descending', 'findus'),
                ),
                'default' => ''
            ]
        );
        ...
        $this->add_control(
            'post_title_color',
            [
                'label' => esc_html__( 'Post Title Color', 'findus' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_group_control(
            Elementor\Group_Control_Typography::get_type(),
            [
                'label' => esc_html__( 'Post Title Typography', 'findus' ),
        ...
        $this->add_control(
            'post_excerpt_color',
            [
                'label' => esc_html__( 'Post Excerpt Color', 'findus' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_group_control(
            Elementor\Group_Control_Typography::get_type(),
            [
                'label' => esc_html__( 'Post Excerpt Typography', 'findus' ),
        ...
        $this->add_control(
            'post_tag_color',
            [
                'label' => esc_html__( 'Post Tag Color', 'findus' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_group_control(
            Elementor\Group_Control_Typography::get_type(),
            [
                'label' => esc_html__( 'Post Tag Typography', 'findus' ),
        ...
        $this->add_control(
            'post_readmore_color',
            [
                'label' => esc_html__( 'Post Read More Color', 'findus' ),
                'type' => Elementor\Controls_Manager::COLOR,
                'selectors' => [
                    // Stronger selector to avoid section style from overwriting
        ...
        $this->add_group_control(
            Elementor\Group_Control_Typography::get_type(),
            [
                'label' => esc_html__( 'Post Read More Typography', 'findus' ),
...
if ( version_compare(ELEMENTOR_VERSION, '3.5.0', '<') ) {
    Elementor\Plugin::instance()->widgets_manager->register_widget_type( new Findus_Elementor_Posts );
} else {
    Elementor\Plugin::instance()->widgets_manager->register( new Findus_Elementor_Posts );
}