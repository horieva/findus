...
<form method="post" id="job_package_selection">
	<?php if ( job_manager_user_can_post_job() || job_manager_user_can_edit_job( $job_id ) ) { ?>
		...
		<div class="job_listing_packages_title">
			...
			<h2><?php esc_html_e( 'Choose from one of your available packages or select a new one:', 'findus' ); ?></h2>
		</div>
...
<div class="job_listing_types">
	...
	<?php } else { ?>
				...
				<div class="ali-center">
					<H2>
				<?php esc_html_e('Please sign in or create and account to submit a listing', 'findus'); ?>
			</H2>
